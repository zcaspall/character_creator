...
ALTER TABLE "public"."Characters" ALTER COLUMN "character_id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
ALTER TABLE "public"."SessionNotes" OWNER TO "postgres";

ALTER TABLE "public"."SessionNotes" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."SessionNotes_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."SessionNotes"
...
ALTER TABLE ONLY "public"."Characters"
    ADD CONSTRAINT "Characters_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "public"."Users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."SessionNotes"
    ADD CONSTRAINT "SessionNotes_game_id_fkey" FOREIGN KEY ("game_id") REFERENCES "public"."Games"("id") ON DELETE CASCADE;
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."JoinedGame" FOR INSERT TO "authenticated" WITH CHECK (true);

CREATE POLICY "Enable insert for authenticated users only" ON "public"."SessionNotes" FOR INSERT TO "authenticated" WITH CHECK (true);

CREATE POLICY "Enable read access for all authenticated users" ON "public"."Games" FOR SELECT TO "authenticated" USING (true);

CREATE POLICY "Enable read access for all users" ON "public"."JoinedGame" FOR SELECT USING (true);

CREATE POLICY "Enable read access for all users" ON "public"."Users" FOR SELECT USING (true);

CREATE POLICY "Enable read for authenticated users only" ON "public"."SessionNotes" FOR SELECT TO "authenticated" USING (true);

CREATE POLICY "Enable update for authenticated users" ON "public"."SessionNotes" FOR UPDATE TO "authenticated" USING (true);
...
GRANT ALL ON TABLE "public"."SessionNotes" TO "anon";
GRANT ALL ON TABLE "public"."SessionNotes" TO "authenticated";
GRANT ALL ON TABLE "public"."SessionNotes" TO "service_role";

GRANT ALL ON SEQUENCE "public"."SessionNotes_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."SessionNotes_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."SessionNotes_id_seq" TO "service_role";
